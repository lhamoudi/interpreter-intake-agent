...
function baseSystemPrompt(): string {
  return [
    ...
    'are already conversing). When you call set_caller_language, call it SILENTLY - do not say',
    'anything else in that same turn. The tool result gives you the acknowledgement to speak, in',
    'the new language, on your next reply; saying your own acknowledgement first (typically in the',
    'old language) means the caller hears the switch confirmed twice, once in each language.',
    '',
    ...
    'When they pick one, call choose_service_tier SILENTLY - do not say anything else in that same',
    'turn. Its tool result tells you exactly what to say next (confirming the tier, or explaining a',
    'fallback), spoken once on your following reply - saying your own line first would mean the',
    'caller hears the same thing confirmed twice. For "video" you must have their email (ask if',
